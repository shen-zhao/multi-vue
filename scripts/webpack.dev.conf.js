...
Object.keys(webpackConfig.entry).forEach(function (name) {
    typeof webpackConfig.entry[name] == 'object' && (webpackConfig.entry[name] = ['./scripts/dev-client.js?path=/__webpack_hmr'].concat(webpackConfig.entry[name]));
})
...
const devWebpackConfig = merge(webpackConfig, {
    ...
    output: {
        publicPath: utils.publicPath('development')
    },
    plugins: [
